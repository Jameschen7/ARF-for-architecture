train_opt_arf()
{
    ...
    #                 --content_weight 5e-3 \
    python opt_style.py -t ${ckpt_arf} ${data_dir} \
                    -c configs/tnt_$3.json  \
                    --init_ckpt ${ckpt_svox2}/ckpt.npz \
                    --style ${style_img} \
                    --mse_num_epoches 1 --nnfm_num_epoches 9 \
                    --content_weight 5e-3 
    #--vgg_block $3
...
# train_opt_arf Playground milan2 geom3e3Clip0.5TNegStylesTV5
# train_opt_arf Playground brutal geom3e3Clip0.5TNegStylesTV5
train_opt_arf Playground brutal geom3e3Clip0.5TNegStylesBlurTV5
# train_opt_arf Playground japanese geom3e3Clip0.5TNegStylesTV5
